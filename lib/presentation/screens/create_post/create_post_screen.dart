            ...
            Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  // Targeting Section
                  ExpansionTile(
                    title: const Text('Targeting Options'),
                    subtitle: const Text('Define who can see this post'),
                    children: [
                      Padding(
                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Interests',
                                hintText:
                                    'e.g., coding, design, marketing (comma-separated)',
                                border: OutlineInputBorder(),
                              ),
                            ),
                            const SizedBox(height: 16),
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Locations',
                                hintText:
                                    'e.g., New York, London, Tokyo (comma-separated)',
                                border: OutlineInputBorder(),
                              ),
                            ),
                            const SizedBox(height: 16),
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Languages',
                                hintText:
                                    'e.g., English, Spanish, French (comma-separated)',
                                border: OutlineInputBorder(),
                              ),
                            ),
                            const SizedBox(height: 16),
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Skills',
                                hintText:
                                    'e.g., Flutter, React, Python (comma-separated)',
                                border: OutlineInputBorder(),
                              ),
                            ),
                            const SizedBox(height: 16),
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintText:
                                    'e.g., Technology, Healthcare, Finance (comma-separated)',
                                border: OutlineInputBorder(),
                              ),
                            ),
                          ],
...
class _PostStepWidgetState extends State<PostStepWidget> {
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<StepTypeModel>(
              ...
              items: widget.stepTypes.map((type) {
  ...
  List<Widget> _buildOptionFields() {
    return _selectedStepType.options.map((option) {
      final controller =
          _optionControllers[option.id] ??= TextEditingController();
      ...
      switch (option.type) {
        case 'select':
          final options = option.config?['options'] as List?;
        ...
        default:
          field = TextFormField(
            ...
            maxLines: option.config?['multiline'] == true ? null : 1,
            style: option.config?['monospace'] == true
                ? const TextStyle(fontFamily: 'monospace')
                : null,
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Please enter ${option.label.toLowerCase()}';
              }
              return null;
            },
          );
