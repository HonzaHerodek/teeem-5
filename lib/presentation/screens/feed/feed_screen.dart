...
import '../../widgets/targeting_filter_dialog.dart';
...
class _FeedViewState extends State<FeedView> {
  ...
  void _showTargetingFilterDialog(BuildContext context, FeedState state) {
    showDialog(
      context: context,
      builder: (_) {
        return TargetingFilterDialog(
          initialCriteria: state.targetingFilter,
          onApply: (criteria) {
            context.read<FeedBloc>().add(FeedTargetingFilterChanged(criteria));
          },
        );
      },
    );
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircularActionButton(
                        ...
                        onPressed: () =>
                            _showTargetingFilterDialog(context, state),
                      ),
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
